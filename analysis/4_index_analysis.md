...
- Max average composition might change from month-to-month due to such reasons as:
	...
	* Some interest could be seasonal
	* Customers become tired of similar interests (like 'Work Comes First Travalers)
	* During the year an audience group in general could change
	* Current bussiness model is not appropriate and thus it should be modified
